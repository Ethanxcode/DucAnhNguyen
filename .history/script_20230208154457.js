...
window.onscroll = function () {
	...
	if (prevScrollpos > currentScrollPos) {
		document.querySelector('.mainHeader').style.top = '0';
	} else {
		document.querySelector('.mainHeader').style.top = '-100px';
	}
...
var iconsThumbnailButton = document.querySelectorAll('.buttonIconsThumnail');
console.log(iconsThumbnailButton);

console.log(heartButton);
iconsThumbnailButton.forEach((element) => {
	element.addEventListener('click', (e) => {
